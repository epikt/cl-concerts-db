...
def get_event_json():
    ...
    for event in events:
        ...
        json_event["participants"] = [ {
                "participant_id" : participant.id,
                "paticipant_first_name" : participant.person.first_name,
                "paticipant_last_name" : participant.person.last_name,
                "participant_gender" : participant.person.gender.name,
                "participant_nationalities" : [ n.name for n in participant.person.nationalities],
                "paticipant_activity" : participant.activity.name if participant.activity else None,
                "paticipant_instrument" : participant.activity.instrument.name if participant.activity.instrument else None,
